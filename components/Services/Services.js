...
export default function Services({ id }) {
  return (
    <section id={id} className="relative w-full h-auto flex flex-col items-center justify-center p-4 z-10">
      {/* کادر عنوان */}
      <div className="bg-purple-600 text-white text-3xl md:text-4xl 
      font-extrabold px-8 py-4 rounded-lg shadow-lg mb-4 mt-36 sm:mt-36">
        Services
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-12 max-w-full p-8">
        {/* کارت ۱ */}
        <div className="service_parent card flex flex-col items-center p-6 shadow-lg rounded-3xl bg-white dark:bg-gray-800 sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 h-85 hover:scale-105 transform transition-all duration-300 hover:shadow-2xl hover:bg-gray-100 dark:hover:bg-gray-700">
